...
// All links redirect to GeeksforGeeks tutorials and references
...
export const learningSubjects: LearningSubject[] = [
  ...
  { id: "python-decorators", title: "Decorators in Python", url: "https://www.geeksforgeeks.org/python-decorators/", difficulty: "intermediate", tags: ["python", "decorators"] },
  ...
  { id: "python-regex", title: "Regular Expressions in Python", url: "https://www.geeksforgeeks.org/regular-expression-python/", difficulty: "intermediate", tags: ["python", "regex"] },

  // ── Mathematics Foundation ──
  { id: "linear-algebra-intro", title: "Linear Algebra for ML", url: "https://www.geeksforgeeks.org/machine-learning/linear-algebra-in-machine-learning/", difficulty: "beginner", tags: ["math", "linear-algebra"] },
  { id: "matrices-vectors", title: "Matrices & Vectors", url: "https://www.geeksforgeeks.org/machine-learning/matrix-in-machine-learning/", difficulty: "beginner", tags: ["math", "matrices"] },
  { id: "eigenvalues-svd", title: "Eigenvalues & SVD", url: "https://www.geeksforgeeks.org/machine-learning/eigenvalues-and-eigenvectors-in-machine-learning/", difficulty: "advanced", tags: ["math", "svd", "pca"] },
  { id: "calculus-for-ml", title: "Calculus for Machine Learning", url: "https://www.geeksforgeeks.org/machine-learning/calculus-in-machine-learning/", difficulty: "intermediate", tags: ["math", "calculus", "derivatives"] },
  { id: "gradient-descent-math", title: "Gradient Descent (Mathematical Foundation)", url: "https://www.geeksforgeeks.org/machine-learning/gradient-descent-in-machine-learning/", difficulty: "intermediate", tags: ["math", "optimization"] },
  ...
  { id: "distributions", title: "Statistical Distributions", url: "https://www.geeksforgeeks.org/common-probability-distributions-in-data-science/", difficulty: "intermediate", tags: ["math", "statistics", "distributions"] },
  ...
  { id: "hypothesis-testing", title: "Hypothesis Testing & P-values", url: "https://www.geeksforgeeks.org/hypothesis-testing-in-machine-learning/", difficulty: "intermediate", tags: ["statistics", "hypothesis-testing"] },
  ...
  { id: "numpy-operations", title: "NumPy Array Operations", url: "https://www.geeksforgeeks.org/numpy-array-operations/", difficulty: "beginner", tags: ["numpy", "broadcasting"] },
  ...
  { id: "pandas-data-cleaning", title: "Data Cleaning with Pandas", url: "https://www.geeksforgeeks.org/data-cleaning-using-pandas/", difficulty: "intermediate", tags: ["pandas", "cleaning"] },
  ...
  { id: "pandas-merge-join", title: "Merge, Join & Concatenate", url: "https://www.geeksforgeeks.org/merge-join-and-concatenate-dataframes/", difficulty: "intermediate", tags: ["pandas", "join"] },
  ...
  { id: "sql-advanced", title: "Advanced SQL (Joins, Subqueries, Window Functions)", url: "https://www.geeksforgeeks.org/sql-join-types-subqueries-window-functions/", difficulty: "intermediate", tags: ["sql", "joins", "window-functions"] },
  ...
  { id: "distribution-plots", title: "Visualizing Distributions (Box, Violin, Histogram)", url: "https://www.geeksforgeeks.org/box-plot-violin-plot-histogram/", difficulty: "intermediate", tags: ["visualization", "statistics"] },
  { id: "correlation-heatmap", title: "Correlation & Heatmaps", url: "https://www.geeksforgeeks.org/heatmap-in-seaborn/", difficulty: "beginner", tags: ["visualization", "correlation"] },
  ...
  { id: "neural-networks", title: "Artificial Neural Networks (ANN)", url: "https://www.geeksforgeeks.org/machine-learning/artificial-neural-networks/", difficulty: "intermediate", tags: ["dl", "ann"] },
  { id: "activation-functions", title: "Activation Functions", url: "https://www.geeksforgeeks.org/machine-learning/activation-functions-in-neural-networks/", difficulty: "intermediate", tags: ["dl", "activation"] },
  { id: "backpropagation", title: "Backpropagation Algorithm", url: "https://www.geeksforgeeks.org/machine-learning/backpropagation-in-neural-networks/", difficulty: "intermediate", tags: ["dl", "backpropagation"] },
  { id: "cnn-intro", title: "Convolutional Neural Networks (CNN)", url: "https://www.geeksforgeeks.org/convolutional-neural-network-cnn-in-deep-learning/", difficulty: "intermediate", tags: ["dl", "cnn"] },
  { id: "rnn-intro", title: "Recurrent Neural Networks (RNN)", url: "https://www.geeksforgeeks.org/recurrent-neural-networks/", difficulty: "intermediate", tags: ["dl", "rnn"] },
  { id: "lstm-gru", title: "LSTM & GRU Networks", url: "https://www.geeksforgeeks.org/long-short-term-memory-networks/", difficulty: "advanced", tags: ["dl", "lstm", "gru"] },
  { id: "tensorflow-tutorial", title: "TensorFlow Tutorial", url: "https://www.geeksforgeeks.org/python/tensorflow-tutorial/", difficulty: "beginner", tags: ["tensorflow", "framework"] },
  ...
  { id: "transfer-learning", title: "Transfer Learning", url: "https://www.geeksforgeeks.org/machine-learning/transfer-learning/", difficulty: "advanced", tags: ["dl", "transfer-learning"] },
  { id: "autoencoders", title: "Autoencoders", url: "https://www.geeksforgeeks.org/deep-learning/autoencoders/", difficulty: "advanced", tags: ["dl", "autoencoder"] },
  ...
  { id: "text-preprocessing", title: "Text Preprocessing (Tokenization, Stemming, Lemmatization)", url: "https://www.geeksforgeeks.org/nlp-text-preprocessing/", difficulty: "beginner", tags: ["nlp", "preprocessing"] },
  { id: "tfidf-bow", title: "TF-IDF & Bag of Words", url: "https://www.geeksforgeeks.org/tf-idf-in-python/", difficulty: "beginner", tags: ["nlp", "tfidf", "bow"] },
  { id: "word-embeddings", title: "Word Embeddings (Word2Vec, GloVe)", url: "https://www.geeksforgeeks.org/word-embedding-in-nlp-methods/", difficulty: "intermediate", tags: ["nlp", "embeddings"] },
  { id: "text-classification", title: "Text Classification Techniques", url: "https://www.geeksforgeeks.org/nlp-text-classification/", difficulty: "intermediate", tags: ["nlp", "classification"] },
  ...
  { id: "pos-tagging", title: "Part-of-Speech Tagging", url: "https://www.geeksforgeeks.org/nlp-part-of-speech-tagging/", difficulty: "intermediate", tags: ["nlp", "pos"] },
  { id: "topic-modeling", title: "Topic Modeling (LDA)", url: "https://www.geeksforgeeks.org/nlp-topic-modeling/", difficulty: "advanced", tags: ["nlp", "lda"] },
  { id: "spacy-tutorial", title: "spaCy NLP Library", url: "https://www.geeksforgeeks.org/python-spacy-tutorial/", difficulty: "intermediate", tags: ["nlp", "spacy"] },
  { id: "nltk-tutorial", title: "NLTK Tutorial", url: "https://www.geeksforgeeks.org/python-nltk-tutorial/", difficulty: "beginner", tags: ["nlp", "nltk"] },
  { id: "text-similarity", title: "Text Similarity & Cosine Similarity", url: "https://www.geeksforgeeks.org/cosine-similarity-in-nlp/", difficulty: "intermediate", tags: ["nlp", "similarity"] },
  ...
  { id: "image-preprocessing", title: "Image Preprocessing Techniques", url: "https://www.geeksforgeeks.org/image-preprocessing-techniques-in-opencv/", difficulty: "intermediate", tags: ["cv", "preprocessing"] },
  { id: "edge-detection", title: "Edge Detection (Canny, Sobel)", url: "https://www.geeksforgeeks.org/edge-detection-opencv-python/", difficulty: "intermediate", tags: ["cv", "edge-detection"] },
  { id: "object-detection", title: "Object Detection (YOLO, SSD, Faster R-CNN)", url: "https://www.geeksforgeeks.org/object-detection/", difficulty: "advanced", tags: ["cv", "object-detection", "yolo"] },
  { id: "image-segmentation", title: "Image Segmentation", url: "https://www.geeksforgeeks.org/image-segmentation/", difficulty: "advanced", tags: ["cv", "segmentation"] },
  { id: "face-detection-recognition", title: "Face Detection & Recognition", url: "https://www.geeksforgeeks.org/face-detection-using-opencv-python/", difficulty: "intermediate", tags: ["cv", "face"] },
  { id: "yolo-object-detection", title: "YOLO for Real-Time Object Detection", url: "https://www.geeksforgeeks.org/yolo-object-detection/", difficulty: "advanced", tags: ["cv", "yolo", "real-time"] },
  { id: "optical-character-recognition", title: "OCR with Tesseract & OpenCV", url: "https://www.geeksforgeeks.org/optical-character-recognition-opencv-python/", difficulty: "intermediate", tags: ["cv", "ocr"] },

  // ── Transformer Architecture ──
  { id: "attention-mechanism", title: "Attention Mechanism", url: "https://www.geeksforgeeks.org/attention-mechanism-in-deep-learning/", difficulty: "advanced", tags: ["transformer", "attention"] },
  { id: "transformer-intro", title: "Transformer Architecture", url: "https://www.geeksforgeeks.org/transformer-neural-network-architecture/", difficulty: "advanced", tags: ["transformer", "architecture"] },
  { id: "bert-intro", title: "BERT (Bidirectional Encoder Representations)", url: "https://www.geeksforgeeks.org/bert-beginners-guide/", difficulty: "advanced", tags: ["transformer", "bert"] },
  { id: "gpt-intro", title: "GPT Architecture (Generative Pre-trained)", url: "https://www.geeksforgeeks.org/gpt-generative-pre-trained-transformer/", difficulty: "advanced", tags: ["transformer", "gpt"] },
  { id: "t5-model", title: "T5 (Text-to-Text Transfer Transformer)", url: "https://www.geeksforgeeks.org/text-to-text-transfer-transformer-t5/", difficulty: "advanced", tags: ["transformer", "t5"] },
  { id: "vision-transformer", title: "Vision Transformer (ViT)", url: "https://www.geeksforgeeks.org/vision-transformer-in-deep-learning/", difficulty: "advanced", tags: ["transformer", "vit", "cv"] },
  { id: "encoder-decoder", title: "Encoder-Decoder Architecture", url: "https://www.geeksforgeeks.org/encoder-decoder-model-in-deep-learning/", difficulty: "advanced", tags: ["transformer", "seq2seq"] },

  // ── Generative AI ──
  { id: "genai-introduction", title: "Introduction to Generative AI", url: "https://www.geeksforgeeks.org/genai-for-beginners-a-complete-guide/", difficulty: "beginner", tags: ["genai", "introduction"] },
  { id: "llm-intro", title: "Large Language Models (LLMs)", url: "https://www.geeksforgeeks.org/introduction-to-large-language-models/", difficulty: "intermediate", tags: ["genai", "llm"] },
  { id: "prompt-engineering", title: "Prompt Engineering", url: "https://www.geeksforgeeks.org/prompt-engineering/", difficulty: "beginner", tags: ["genai", "prompting"] },
  { id: "prompt-engineering-advanced", title: "Advanced Prompting (Chain-of-Thought, Few-Shot)", url: "https://www.geeksforgeeks.org/prompt-engineering-techniques/", difficulty: "intermediate", tags: ["genai", "prompting"] },
  { id: "rag-intro", title: "Retrieval-Augmented Generation (RAG)", url: "https://www.geeksforgeeks.org/retrieval-augmented-generation-rag/", difficulty: "intermediate", tags: ["genai", "rag"] },
  { id: "fine-tuning-llm", title: "Fine-tuning LLMs", url: "https://www.geeksforgeeks.org/fine-tuning-large-language-models/", difficulty: "advanced", tags: ["genai", "fine-tuning"] },
  ...
  { id: "llamaindex-intro", title: "LlamaIndex Tutorial", url: "https://www.geeksforgeeks.org/llamaindex-tutorial/", difficulty: "intermediate", tags: ["genai", "llamaindex"] },
  { id: "vector-databases", title: "Vector Databases (Pinecone, ChromaDB)", url: "https://www.geeksforgeeks.org/vector-databases-in-ai/", difficulty: "intermediate", tags: ["genai", "vectors", "embeddings"] },
  { id: "ai-agents-intro", title: "AI Agents & Tool Use", url: "https://www.geeksforgeeks.org/ai-agents/", difficulty: "advanced", tags: ["genai", "agents"] },
  { id: "diffusion-models", title: "Diffusion Models for Image Generation", url: "https://www.geeksforgeeks.org/diffusion-models/", difficulty: "advanced", tags: ["genai", "diffusion", "image-generation"] },
  { id: "text-to-image", title: "Text-to-Image Generation (Stable Diffusion, DALL-E)", url: "https://www.geeksforgeeks.org/text-to-image-generation/", difficulty: "advanced", tags: ["genai", "stable-diffusion"] },
  { id: "openai-api", title: "OpenAI API (GPT-4, DALL-E, Whisper)", url: "https://www.geeksforgeeks.org/openai-api-tutorial/", difficulty: "intermediate", tags: ["genai", "openai", "api"] },
  ...
  { id: "genai-evaluation", title: "Evaluating GenAI Models", url: "https://www.geeksforgeeks.org/evaluation-metrics-for-llms/", difficulty: "advanced", tags: ["genai", "evaluation"] },
  ...
  { id: "mlflow-tutorial", title: "MLflow for Experiment Tracking", url: "https://www.geeksforgeeks.org/mlflow-tutorial/", difficulty: "intermediate", tags: ["mlops", "mlflow", "tracking"] },
  ...
  { id: "model-monitoring", title: "ML Model Monitoring", url: "https://www.geeksforgeeks.org/mlops-model-monitoring/", difficulty: "advanced", tags: ["mlops", "monitoring"] },
  { id: "ci-cd-ml", title: "CI/CD for Machine Learning", url: "https://www.geeksforgeeks.org/ci-cd-for-machine-learning/", difficulty: "advanced", tags: ["mlops", "cicd"] },
  { id: "aws-ml-services", title: "AWS ML Services (SageMaker, Lambda)", url: "https://www.geeksforgeeks.org/aws-sagemaker-tutorial/", difficulty: "intermediate", tags: ["mlops", "aws", "cloud"] },

  // ── Data Engineering ──
  { id: "data-engineering-intro", title: "Introduction to Data Engineering", url: "https://www.geeksforgeeks.org/data-engineering/", difficulty: "beginner", tags: ["data-eng", "introduction"] },
  { id: "etl-pipelines", title: "ETL Pipelines", url: "https://www.geeksforgeeks.org/etl-extract-transform-load/", difficulty: "intermediate", tags: ["data-eng", "etl"] },
  { id: "apache-spark", title: "Apache Spark for Big Data", url: "https://www.geeksforgeeks.org/apache-spark-tutorial/", difficulty: "intermediate", tags: ["data-eng", "spark", "big-data"] },
  { id: "data-lakes", title: "Data Lakes & Warehouses", url: "https://www.geeksforgeeks.org/data-lake-vs-data-warehouse/", difficulty: "intermediate", tags: ["data-eng", "data-lake"] },
  { id: "streaming-data", title: "Real-Time Data Streaming (Kafka)", url: "https://www.geeksforgeeks.org/apache-kafka-tutorial/", difficulty: "advanced", tags: ["data-eng", "kafka", "streaming"] },
  { id: "airflow-tutorial", title: "Apache Airflow for Orchestration", url: "https://www.geeksforgeeks.org/apache-airflow-tutorial/", difficulty: "intermediate", tags: ["data-eng", "airflow", "orchestration"] },
  { id: "data-quality", title: "Data Quality & Validation", url: "https://www.geeksforgeeks.org/data-quality-validation/", difficulty: "intermediate", tags: ["data-eng", "quality"] },
  ...
  { id: "system-design-ml", title: "System Design for ML Engineers", url: "https://www.geeksforgeeks.org/system-design-interview-questions/", difficulty: "advanced", tags: ["dsa", "system-design"] },
];

export function getSubjectsByCategory(categoryId: string): LearningSubject[] {
  return learningSubjects.filter((s) => {
    const catStart = categoryId;
    return s.id.startsWith(catStart.split("-")[0]) || (
      categoryId === "math-foundation" && (s.tags.includes("math") || s.tags.includes("statistics")) ||
      categoryId === "dsa" && s.tags.includes("dsa") ||
      true && s.category === categoryId
    );
  });
}

// Simpler categorization based on IDs
export function getSubjectsByCategorySimple(categoryId: string): LearningSubject[] {
  // Map category IDs to subject ID prefixes
